...
namespace InteresMe.API.Data.Migrations
{
    ...
    [Migration("20260624093347_AddPostCommentReplies")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InteresMe.API.Modules.Chat.Shared.Models.ChatMessageAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("chat_message_attachments", "chat", t =>
                        {
                            t.HasCheckConstraint("CK_chat_message_attachments_size_positive", "\"SizeBytes\" > 0");
                        });
                });
            ...
            modelBuilder.Entity("InteresMe.API.Modules.History.Models.UserHistoryEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("user_history_events", "history");
                });
            ...
            modelBuilder.Entity("InteresMe.API.Modules.Interests.Models.InterestCategory", b =>
                {
                    ...
                    b.ToTable("interest_categories", "interests");
                });

            modelBuilder.Entity("InteresMe.API.Modules.Interests.Models.Subinterest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("InterestId", "Slug")
                        .IsUnique();

                    b.ToTable("subinterests", "interests");
                });
            ...
            modelBuilder.Entity("InteresMe.API.Modules.Profile.Models.UserFollow", b =>
                {
                    ...
                    b.ToTable("user_follows", "profile");
                });
            ...
            modelBuilder.Entity("InteresMe.API.Modules.Chat.Shared.Models.ChatMessageAttachment", b =>
                {
                    b.HasOne("InteresMe.API.Modules.Chat.Shared.Models.ChatMessage", "ChatMessage")
            ...
            modelBuilder.Entity("InteresMe.API.Modules.Interests.Models.Interest", b =>
                {
                    b.HasOne("InteresMe.API.Modules.Interests.Models.InterestCategory", "Category")
                        .WithMany("Interests")
            ...
            modelBuilder.Entity("InteresMe.API.Modules.Posts.Comments.Models.Comment", b =>
                {
                    ...
                    b.HasOne("InteresMe.API.Modules.Posts.Comments.Models.Comment", "ParentComment")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("InteresMe.API.Modules.Profile.Models.UserFollow", b =>
                {
                    b.HasOne("InteresMe.API.Modules.Auth.Models.User", "Followed")
                        .WithMany()
                        .HasForeignKey("FollowedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InteresMe.API.Modules.Auth.Models.User", "Follower")
                        .WithMany()
