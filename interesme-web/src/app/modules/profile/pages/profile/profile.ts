...
export class ProfileComponent implements OnInit {
  ...
  readonly text = computed(() => {
    ...
    return {
      ...
      noPostsTitle: this.i18n.t('profileView.posts.emptyTitle'),
      noOwnPostsDescription: this.i18n.t('profileView.posts.emptyOwnDescription'),
      noPublicPostsDescription: this.i18n.t('profileView.posts.emptyPublicDescription'),
      createPost: this.i18n.t('profileView.posts.create'),
      loadingPostsTitle: this.i18n.t('profileView.posts.loadingTitle'),
      loadingPostsDescription: this.i18n.t('profileView.posts.loadingDescription'),
      loadMorePosts: this.i18n.t('profileView.posts.loadMore'),
      loadingMorePosts: this.i18n.t('profileView.posts.loadingMore'),
      postsEnd: this.i18n.t('profileView.posts.end'),
